...
import com.axisframework.eventhandling.UnsupportedHandlerMethodException;
...
public class AnnotationEventHandlerInvoker extends AbstractHandlerInvoker {
     ...
     * com.axisframework.eventhandling.annotation.BeforeTransaction}
     *
     ...
     * com.axisframework.eventhandling.annotation.AfterTransaction}
     *
     * @param transactionStatus The status of the transaction to pass as parameter to the method call
     */
