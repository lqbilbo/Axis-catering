 ...
 * is missing.
 * <p/>
 * To prevent this exception, make a method that accepts a {@link com.axisframework.domain.DomainEvent} as sole
 * parameter and annotate it with {@link com.axisframework.eventhandling.annotation.EventHandler}.
 *
...
public class UnhandledEventException extends RuntimeException {
    ...
    private static final long serialVersionUID = 1631815667482196947L;
