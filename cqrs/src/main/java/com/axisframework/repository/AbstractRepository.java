...
import com.axisframework.domain.AggregateRoot;
...
/**
 * Abstract implementation of the {@link com.axisframework.repository.Repository} that takes care of the dispatching of events when an aggregate is
 ...
 * deal with concurrency. Alternatively, consider using the {@link com.axisframework.repository.LockingRepository}.
 *
 * @author Allard Buijze
 * @param <T> The type of aggregate this repository stores
 * @see #setEventBus(EventBus)
