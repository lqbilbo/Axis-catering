package com.threequick.catering.query.config;
...
@Configuration
@Profile("hsqldb")
@EnableJpaRepositories(basePackages = "com.threequick.catering.query.*.repositories",
...
public class HsqlDbConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(DataSource dataSource) {
        ...
        container.setPersistenceUnitName("catering");
