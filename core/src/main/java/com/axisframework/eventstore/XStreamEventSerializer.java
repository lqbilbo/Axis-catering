...
public class XStreamEventSerializer implements EventSerializer {
     ...
     * {@inheritDoc}
     *
     * @throws com.axisframework.eventstore.EventStoreException if the configured encoding is not available in this JVM.
     */
    @Override
    public byte[] serialize(DomainEvent event) {
        ...
        try {
            ...
            throw new com.axisframework.eventstore.EventStoreException("The '" + charsetName + "' encoding is not supported.", e);
        }
     ...
     * <p/>
     * E.g. an alias of "axoncore" for the package "com.axisframework.core" will use "axoncore.repository" for the
     * package "com.axisframework.core.repository".
     *
