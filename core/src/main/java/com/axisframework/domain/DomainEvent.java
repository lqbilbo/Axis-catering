...
public abstract class DomainEvent extends EventBase {
     ...
     * constructor when using the {@link com.axisframework.eventsourcing.AbstractEventSourcedAggregateRoot#apply(DomainEvent)}
     ...
     * <p/>
     * If you do not use the {@link com.axisframework.eventsourcing.AbstractEventSourcedAggregateRoot#apply(DomainEvent)}
     * method, but need the <code>sequenceNumber</code> and <code>aggregateIdentifier</code> to be set to specific
     * values, use the {@link DomainEvent#DomainEvent(long, UUID)} constructor.
     */
     ...
     * <p/>
     * When creating a DomainEvent using this constructor, all calls to {@link #setAggregateIdentifier(UUID)}
     ...
     * {@link com.axisframework.core.EventContainer}.
     *
