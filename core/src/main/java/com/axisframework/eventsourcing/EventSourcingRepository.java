...
import com.axisframework.repository.AggregateNotFoundException;
import com.axisframework.repository.LockingRepository;
import com.axisframework.repository.LockingStrategy;
 ...
 * automatically publish new events to the given {@link com.axisframework.eventhandling.EventBus} and delegate event
 * storage to the provided {@link EventStore}.
 *
 * @author Allard Buijze
 * @param <T> The type of aggregate this repository stores
 * @see com.axisframework.eventsourcing.EventSourcedAggregateRoot
 * @see com.axisframework.eventsourcing.AbstractEventSourcedAggregateRoot
 * @see com.axisframework.eventsourcing.annotation.AbstractAnnotatedAggregateRoot
 * @see EventStore
 * @see com.axisframework.eventstore.fs.FileSystemEventStore
 * @since 0.1
 */
public abstract class EventSourcingRepository<T extends EventSourcedAggregateRoot> extends LockingRepository<T> {
     ...
     *
     * @see LockingRepository#LockingRepository()
     */
